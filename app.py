...
if selected_model == "Freight Cost Prediction":
    ...
    st.markdown("""
    **Objective:**
    Predict freight cost using **Invoice Dollars only** (after removing multicollinearity issues).
    """)
    ...
    if submit_freight:
        ...
        # ✅ MUST MATCH TRAINED FEATURE NAME EXACTLY
        input_data = {
            "Dollars": dollars
        }
...
# -------------------------------------------------------------------------
# INVOICE FLAG PREDICTION (NO THRESHOLD VERSION)
# -------------------------------------------------------------------------
else:
    ...
    st.markdown("""
    **Objective:**
    Predict invoice risk using ML probability scoring.
    """)
    ...
    if submit_flag:
        ...
        risk_score = result["Risk_Probability"].iloc[0]
